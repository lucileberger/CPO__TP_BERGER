...
public class GrilledeCellules {
     ...
     * Initialise une nouvelle grille de cellules avec le nombre de lignes et de colonnes spécifié.
     * Chaque cellule est initialisée comme étant éteinte.
     *
    ...
    */
    public boolean estTouteEteinte() {
    for (int ligne = 0; ligne < nbLignes; ligne++) {
        for (int colonne = 0; colonne < nbColonnes; colonne++) {
    ...
    /**
     * Crée une représentation textuelle de la grille avec l'état actuel des cellules.
